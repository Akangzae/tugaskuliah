    ...
    <section id="isi" class="pemesanan">
        ...
        <form method="POST">
            ...
            <select id="lapangan" name="lapangan" required>
                ...
                <option value="Futsal Bersama">Futsal Bersama</option>
                <option value="Terenggiling Ball">Terenggiling Ball</option>
            </select>
        ...
        <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["nama"]) && isset($_POST["lapangan"])) {
        $nama = $_POST["nama"];
        $lapangan = $_POST["lapangan"];
        echo "<p>Terima kasih, $nama, Anda telah memesan lapangan <b> $lapangan <b>.</p>";
    }
    ?>
